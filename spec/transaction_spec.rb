...
RSpec.describe Transaction do
  ...
  it "returns all expected attributes" do
    ...
    #expect(transaction.transaction_attributes[:credit_card_expiration_date]).to eq 0125
    #expect(transaction.transaction_attributes[:credit_card_expiration_date]).to eq '0125'
    #expect(transaction.transaction_attributes[:credit_card_expiration_date]).to eq '0125'.to_i
    #the above are great test cases for leading zeroes in expiration date...
    #here i was playing with it and testing and actuals and expected shifted around...
